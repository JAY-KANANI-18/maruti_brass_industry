...
const items = [
  {
    id: 1,
    title: "CNC Turning",
    content: "Precision turning for complex geometries.",
    icon: "pe-7s-settings",
  ...
  },
  {
    id: 2,
    title: "Forging",
    content: "High‑strength forged components for durability.",
    icon: "pe-7s-hammer",
  ...
  },
  {
    id: 3,
    title: "Casting",
    content: "Consistent quality with close tolerances.",
    icon: "pe-7s-cup",
  ...
  },
  {
    ...
    content: "Tight tolerances using advanced tooling.",
    icon: "pe-7s-tools",
